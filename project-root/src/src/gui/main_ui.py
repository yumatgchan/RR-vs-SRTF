...
# ══════════════════════════════════════════════════════════════════════════════
#  GANTT CHART  –  plain white blocks, black outline, no colours
# ══════════════════════════════════════════════════════════════════════════════
...
def draw_gantt(canvas, gantt, y_offset=0, title=""):
    ...
    for p, start, end in gantt:
        ...
        canvas.create_rectangle(x, 28 + y_offset, x + width, 75 + y_offset,
                                 fill=fill, outline="black")
        canvas.create_text(x + width / 2, 51 + y_offset, text=p,
                           font=("Arial", 9))
        canvas.create_text(x, 85 + y_offset, text=str(start),
                           font=("Arial", 8))
...
# ══════════════════════════════════════════════════════════════════════════════
#  COMPARISON TABLE  –  plain, no colour overload
# ══════════════════════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════════════════════
#  BEST ALGORITHM  –  one simple line
# ══════════════════════════════════════════════════════════════════════════════
...
scrollbar_main = tk.Scrollbar(main_container, orient="vertical",
...
tk.Button(control_frame, text="Create Inputs",
          command=create_inputs).pack(side="left", padx=5)
tk.Button(control_frame, text="Run",
          command=run).pack(side="left", padx=5)
tk.Button(control_frame, text="Reset",
          command=reset_all, bg="red", fg="white").pack(side="left", padx=5)
...
scroll_x     = tk.Scrollbar(gantt_outer, orient="horizontal",
